    ...
    async def disclaimer(self, ctx: commands.Context):
        ...
        embed.add_field(
            ...
            value=(
                ...
                "- **Actions**\n*Actions such as joining/leaving channels, role changes, and other interactions.*\n"
                "- **Signals**\n*Trust signals generated by Discord based on account activity patterns.*\n"
            ),
            inline=False
        )
        embed.add_field(
            name="How long is data stored for?",
            value="Data collected will be stored for up to **1 year**, a cyclical period beginning **January 1** of a calendar year and ending the **last day of December**.",
            inline=False
        )
        embed.add_field(
        ...
        embed.add_field(
            name="In summary",
            value="Provided we're not placed in a position where we must acknowledge and/or disclose data collected about you due to abusive and/or criminal activity observed or detected, we'll forget about you on an annual basis. Anything we collect about you in the meantime, we'll share with nobody."
        )
        embed.add_field(
        ...
        view.add_item(discord.ui.Button(label="Read our Terms of Service", url="https://www.beehive.systems/tos", style=discord.ButtonStyle.link, emoji="🔗"))
        view.add_item(discord.ui.Button(label="Read our Privacy Policy", url="https://www.beehive.systems/privacy", style=discord.ButtonStyle.link, emoji="🔗"))
        await ctx.send(embed=embed, view=view)
