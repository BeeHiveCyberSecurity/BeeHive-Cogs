            ...
            with open(file_path, "r") as file:
                ...
                for line in lines[:5]:  # Limit to the first 5 lines for brevity
                    ...
                    if len(columns) >= 8:
                        ...
                        embed.add_field(name="Device view", value="", inline=False)
                        ...
                        embed.add_field(name=f"{active_devices_malicious_activity}%", value="of devices had malicious activity filtered by **Virtualization**", inline=False)
