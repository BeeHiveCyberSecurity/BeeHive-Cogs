...
#            1081164568669200384: "https://buy.stripe.com/5kA8y62kIg06dLqdRc?prefilled_promo_code=DIRTYTHR33&utm_source=discord&utm_medium=partnerperk",  # Red Lotus (Departnered)
    ...
    async def reviewprompt(self, ctx: commands.Context):
        ...
        view = discord.ui.View()
        view.add_item(discord.ui.Button(label="via TrustPilot", url="https://www.trustpilot.com/review/beehive.systems", style=discord.ButtonStyle.link, emoji="🔗"))
