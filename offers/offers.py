...
class Offers(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.offers_data = {
            "Adult": [
                {"title": "Puffco", "description": "Puffco offers innovative products designed to enhance the experience of using concentrates. Our focus is on elegance, simplicity, and providing a comprehensive sensory experience. Discover new flavors, sensations, and mental clarity with Puffco's unique approach.", "offer": "$30 off valid for first-time Puffco customers only, $150 cart minimum. Cart must include a Pivot, Peak, Proxy, Peak Pro or Plus. This offer does not apply to new products within the first 30 days of their release. Discount codes cannot stack.", "link": "http://rwrd.io/sb3mpvr", "logo": "https://cdn.brandfetch.io/idD9NYRknz/w/2000/h/3478/theme/dark/logo.png?c=1dxbfHSJFAPEGdCLU4o5B", "color": 0x000000}
            ],
            "Business": [
                ...
                {"title": "Stable", "description": "Stable is a virtual address company that provides businesses with a professional mailing address and mail handling services. It helps businesses maintain a professional image and manage their correspondence efficiently.", "offer": "Sign up for Stable using the link below to get started with a virtual address for your business and save 20% on your first year of any plan.", "link": "https://dashboard.usestable.com/onboard/begin?promoCode=jace-a2982bstref", "logo": "https://cdn.brandfetch.io/id0xdiUGFo/w/400/h/400/theme/dark/icon.jpeg?c=1dxbfHSJFAPEGdCLU4o5B", "color": 0x3066be}
            ],
            "Telephony": [
                {"title": "Mint Mobile", "description": "Mint Mobile offers affordable wireless plans with unlimited talk and text, and high-speed data on the nation's fastest, most advanced 5G networks. Mint Mobile is perfect for those looking to save money on their phone bill without sacrificing service availability.", "offer": "Become a new Mint Mobile customer using the link below and get $15 of billing credit as a gift.", "link": "https://fbuy.me/uYoak", "logo": "https://play-lh.googleusercontent.com/R5rZPSFJux2MIKRSkwkxIbh7bPB-8uiSV0u2zZ9E7R_LsPuXRRqgzxAYa2xMeOyBlA", "color": 0x68AF85}
            ]
        }
