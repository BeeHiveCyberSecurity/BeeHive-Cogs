...
class Offers(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.offers_data = {
            ...
            "Telephony": [
                {"title": "Mint Mobile", "description": "Mint Mobile offers affordable wireless plans with unlimited talk and text, and high-speed data on the nation's fastest, most advanced 5G networks. Mint Mobile is perfect for those looking to save money on their phone bill without sacrificing service availability.", "offer": "Become a Mint Mobile customer using the link below and get $15 of billing credit as a gift.", "link": "https://fbuy.me/uYoak", "logo": "https://play-lh.googleusercontent.com/R5rZPSFJux2MIKRSkwkxIbh7bPB-8uiSV0u2zZ9E7R_LsPuXRRqgzxAYa2xMeOyBlA", "color": 0x68AF85}
            ]
        }
