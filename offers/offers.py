    ...
    def __init__(self, bot):
        ...
        self.offers_data = {
            ...
            "Business": [
                ...
                {"title": "Brex", "description": "Brex is a financial technology company that offers business credit cards and cash management accounts to startups.", "offer": "Sign up for Brex using the link below and get a $500 gift card when you spend $8,000 in your first month.", "link": "https://brex.com/signup?rc=ET0xAhr", "logo": "https://cdn.brandfetch.io/idu49Dl4i8/theme/dark/idKagHeH6-.svg?c=1dxbfHSJFAPEGdCLU4o5B", "color": 0xf46a35}
            ]
        }
