...
class Disclaimers(commands.Cog):
    def __init__(self, bot: Red):
        ...
        self.predefined_disclaimers = {
            ...
            "trader": "This user is a professional trader, but they are not your personal financial advisor. Any information or opinions shared are intended for general informational purposes only and should not be considered trading or investment advice. Investing in financial markets involves serious risk and the potential for significant financial loss. The information provided does not take into account your individual financial situation, investment goals, or risk tolerance. For personalized investment advice and strategies, please consult with a licensed financial advisor or investment professional who can offer recommendations based on your specific circumstances. Always conduct your own research and consider your risk tolerance before making any investment decisions."
        }
